...
from train.pipeline import PipelineState, Callback
...
class AverageMetric(Callback):
    ...
    def on_batch_end(self, pipeline_state: PipelineState, **kwargs):
        last_target = pipeline_state.last_target
    ...
    def on_epoch_end(self, pipeline_state: PipelineState, **kwargs):
